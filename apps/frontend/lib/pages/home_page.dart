...
import 'borrow_equipment_page.dart';
import 'return_equipment_page.dart';
              ...
              if (value == 'delete') {
                    ...
                    content: Column(
                      ...
                      children: [
                        TextField(
                          ...
                          decoration:
                              const InputDecoration(labelText: 'Votre email'),
                        ),
                        const SizedBox(height: 8),
                        const Text(
                ...
                showDialog(
                  ...
                  builder: (context) => AlertDialog(
                    ...
                    content:
                        const Text('Contactez le support ou consultez la FAQ.'),
                    actions: [
                      TextButton(
                        onPressed: () => Navigator.pop(context),
                        child: const Text('Fermer'),
